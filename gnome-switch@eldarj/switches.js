...
export function getSwitchDefs(ctrl) {
    return [
        {
            id: 'dark-mode', label: 'Dark Mode', icon: 'weather-clear-night-symbolic',
        ...
        {
            id: 'night-light', label: 'Night Light', icon: 'night-light-symbolic',
            section: 'display', type: 'toggle',
        ...
        {
            id: 'high-contrast', label: 'High Contrast', icon: 'display-brightness-symbolic',
            section: 'display', type: 'toggle',
        ...
        {
            id: 'reduce-animations', label: 'No Animations', icon: 'media-skip-forward-symbolic',
            section: 'display', type: 'toggle',
        ...
        {
            id: 'hot-corners', label: 'Hot Corners', icon: 'zoom-in-symbolic',
            section: 'display', type: 'toggle',
        ...
        {
            id: 'output-mute', label: 'Mute', icon: 'audio-volume-muted-symbolic',
        ...
        {
            id: 'mic-mute', label: 'Mic Off', icon: 'microphone-sensitivity-muted-symbolic',
            section: 'sound', type: 'toggle',
        ...
        {
            id: 'wifi', label: 'Wi-Fi', icon: 'network-wireless-symbolic',
        ...
        {
            id: 'bluetooth', label: 'Bluetooth', icon: 'bluetooth-active-symbolic',
            section: 'connectivity', type: 'toggle',
        ...
        {
            id: 'airplane-mode', label: 'Airplane', icon: 'airplane-mode-symbolic',
            section: 'connectivity', type: 'toggle',
        ...
        {
            id: 'vpn', label: 'VPN', icon: 'network-vpn-symbolic',
            section: 'connectivity', type: 'toggle',
            isActive: () => ctrl.isVpn(),
        ...
        {
            id: 'location', label: 'Location', icon: 'find-location-symbolic',
            section: 'connectivity', type: 'toggle',
        ...
        {
            id: 'keep-awake', label: 'Keep Awake', icon: 'my-computer-symbolic',
            section: 'power', type: 'toggle',
            isActive: () => ctrl.isKeepAwake(),
            toggle:   () => { ctrl.toggleKeepAwake(); },
            watch:    _cb => () => {}, // state is internal, no external signal needed
        },
        {
            id: 'auto-suspend', label: 'Auto Sleep', icon: 'system-suspend-symbolic',
            section: 'power', type: 'toggle',
        ...
        {
            id: 'keyboard-backlight', label: 'Kbd Light', icon: 'input-keyboard-symbolic',
            section: 'power', type: 'toggle',
        ...
        {
            id: 'dnd', label: 'Do Not Disturb', icon: 'notifications-disabled-symbolic',
        ...
        {
            id: 'screen-lock', label: 'Screen Lock', icon: 'changes-prevent-symbolic',
            section: 'privacy', type: 'toggle',
        ...
        {
            id: 'lock-now', label: 'Lock Now', icon: 'system-lock-screen-symbolic',
        ...
        {
            id: 'touchpad', label: 'Touchpad', icon: 'input-touchpad-symbolic',
        ...
        {
            id: 'magnifier', label: 'Magnifier', icon: 'zoom-fit-best-symbolic',
        ...
        {
            id: 'large-text', label: 'Large Text', icon: 'format-text-larger-symbolic',
            section: 'accessibility', type: 'toggle',
